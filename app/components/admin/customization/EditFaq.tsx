...
} from "@/app/redux/feature/layout/layoutApi";
...
const EditFaq = () => {
  ...
  return (
    <div className="w-[40%] mx-auto lg:mt-[50px]">
      <Toaster />
      {questions?.map((faq: any, index: number) => (
        <div key={index} className="">
          <div className="">
            <div className="flex items-center justify-between cursor-pointer gap-1">
              <h1>{faq.question}</h1>
              <span onClick={() => toggleAnswerVisibility(index)}>
